...
from bmi_calculator.ui.custom_widgets import show_message_box
...
class InputWidget(QWidget):
    ...
    remove_user_signal = pyqtSignal(int) # user_id
    ...
    def init_ui(self):
        ...
        user_layout.addWidget(self.remove_user_btn)
    ...
    def remove_user(self):
        ...
        if user_id is not None:
            self.remove_user_signal.emit(user_id)
        else:
            show_message_box(self, QMessageBox.Icon.Warning, "Error", "Please select a user to remove.")
    ...
    def calculate(self):
        try:
            ...
            show_message_box(self, QMessageBox.Icon.Warning, "Input Error", "Please enter valid numbers for weight and height.")
